...
export const faqQuestions = [
  ...
  },
  {
    ...
    a: 'Нет, на этапе бета тестировани API интеграций не обязательна. Достаточно скачать стандартные отчёты из личного кабинета маркетплейса и загрузить их в сервис.',
  },
  {
